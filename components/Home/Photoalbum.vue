    ...
    <section class="text-gray-600 body-font bg-section">
        ...
        <div class="container px-5 py-24 mx-auto flex flex-wrap">
            <div class="flex w-full mb-20 flex-wrap">
                ...
                <p class="lg:pl-6 lg:w-2/3 mx-auto leading-relaxed text-base text-gray-100">The cafe is a great place to relax with
            ...
            <div class="flex flex-wrap md:-m-2 -m-1">
                <div class="flex flex-wrap w-full md:w-1/2">
                    <div class="md:p-2 p-1 w-1/2">
                        <a href="https://res.cloudinary.com/poliweb/image/upload/c_fill,g_center,w_1920/v1667621749/CHEF%20BREAKFAST/CafeComfort/CaffeComfort2_xk7p3a.webp"
                    ...
                    <div class="md:p-2 p-1 w-1/2">
                        <a href="https://res.cloudinary.com/poliweb/image/upload/c_fill,g_center,w_1920/v1667621739/CHEF%20BREAKFAST/CafeComfort/CaffeComfort1_ygjrfj.webp"
                            data-fancybox="gallery-daynight"
                            data-caption="The cafe is a great place to relax with friends on weekends.">
                            <div class="transformImg">
                                <img alt="The cafe is a great place to relax with friends on weekends."
            ...
            <div class="mx-auto mt-24">
                <a href="tel:+12345678901" class="btn-primary-white inline-flex items-center">Call My <IconsPhonearrow class="w-4 h-4 ml-1"/></a>
            </div>
        </div>
    </section>
</template>
